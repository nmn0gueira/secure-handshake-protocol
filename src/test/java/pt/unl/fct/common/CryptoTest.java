...
public class CryptoTest {
    ...
    public void testAlgorithm() {
        CryptoHandler cryptoHandler1 = new CryptoHandler(DEFAULT_CRYPTO_CONFIG_FILE);
        assertEquals("AES", cryptoHandler1.getAlgorithm());
    }

    @Test
    public void testKeySize() {
        String key = "2a619240bb2d5acfcbcb47387ba80174c0934326d683ad20ef388e7e5150d26e";
        byte[] keyBytes = CommonUtils.hexStringToByteArray(key);
    ...
    public void testIVSize(){
        ...
        byte[] ivBytes = CommonUtils.hexStringToByteArray(iv);
